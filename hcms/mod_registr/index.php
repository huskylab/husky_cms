...
<p>Компания &laquo;Дружба&raquo; представляет новинку на рынке отделочных материалов в сфере создания интерьеров.<br />
  </p>
<p>Это новый, современный, влагостойкий материал, изготовленный из высокотехнологичного прессованного полистирола, позволяет сделать внутреннее пространство оригинальным, помогает рождаться новым дизайнерским идеям.<br />
  </p>
<p>Новинка, которую мы представляем на российском рынке, уже зарекомендовала себя в профессиональной среде, и получила огромный положительный отклик на прошедших выставках в Москве.<br />
  </p>
<p>Интерьер, созданный с помощью конструкционного пластикового багета, выглядит очень эффектно. Но внешняя привлекательность - не единственный плюс эксклюзивной новинки.  Он в 4-5 раз дешевле аналогов из дерева, легко поддаётся резке, монтируется на жидкие гвозди, не боится воды, долговечен. <br />
  </p>
<p>Мы представляем различные варианты багета: по размеру, цветовой гамме, рисунку, что немаловажно в разработке концепции интерьера.<br />
  </p>
<p>Интерьерный пластиковый багет, выполнен под состаренное золото, медь, серебро, дерево. Поверхность багета покрыта ламинирующей плёнкой, нанесённой в термо-прессе под давлением, и позволяет применять этот отделочный материал без дополнительной обработки. Он используется для оформления интерьеров вместо обычного потолочного карниза, плинтуса, угловых реек и различных вставок. <br />
  </p>
<p>Конструкционный багет из пластика применяется для декоративной отделки квартир, коттеджей, торговых залов, гостиниц, кафе, ресторанов и других помещений.
  Он нашёл так же своё применение в мебельном производстве, для отделки фасадов мебели и декоративных добавлениях.<br />
</p>
<h2><strong>Имеем склад в Москве</strong></h2> <p>Осуществляем доставку автомобильным транспортом.</p></div>
</div>
<!--[if lt IE 13]><div style="float:left; width:25%"><![endif]-->
<!--[if !IE]>--> <div style="float:left; width:28%"><!--<![endif]-->

<div style="overflow:hidden" id="content_kolonka" ><h1>Авторизация</h1>
<?PHP 
include 'admin/auth_form.php';
?>
</div>
<div style="overflow:hidden"  id="content_kolonka" ><h1>Корзина</h1>
...
<!--[if lt IE 13]><div style="float:left; width:44%;  margin-right:0.5%"><![endif]-->

<!--[if !IE]>--> <div style="float:left; width:49%;  margin-right:0.5%"><!--<![endif]--> 

<div style="text-align:center;">

<div id="content_button_left"></div><div id="content_button_right">Образцы</div>
</div>
</div>
...
<div id="content_button_left"></div><div id="content_button_right">Видео</div>
</div>
</div>
</div>
...
<!--[if !IE]>--><div style="float:left; width:49%;  margin-right:0.5%"><!--<![endif]--> 
<div id="content_kolonka" style="height:75px">
<h1>Продукция</h1>
<p>Представляем вашему вниманию следующие виды интерьерного багета: карниз потолочный; настенный молдинг; плинтус; угловой молдинг <a href="/produkt/">&gt;&gt;&gt;</a></p>
</div>
</div>
...
<p>Правильное использование интерьерного багета, тонкости и особенности <a href="/video/">&gt;&gt;&gt;</a></p>
<p>&nbsp;</p>
</div>
</div>
</div>

<!--style="clear:both;" - замена пустого div'а (после float) -->
<div style="text-align:center; clear:both; width:99%"> 
<div id="content_button_left"></div><div id="content_button_right">Фотоальбом</div>
</div>

<div align="center">
<table width="90%" border="0" cellspacing="4" cellpadding="0">
  <tr>
    <td align="left"><img src="http://pro-baget.ru/bg/foto_1.png"/></td>
    <td align="left"><img src="http://pro-baget.ru/bg/foto_2.png" /></td>
    <td align="left"><img src="http://pro-baget.ru/bg/foto_3.png" /></td>
    <td align="left"><img src="http://pro-baget.ru/bg/foto_4.png" /></td>
  </tr>
</table>
</div>
